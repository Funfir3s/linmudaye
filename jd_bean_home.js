...
[task_local]
#领京豆额外奖励
23 1,18 * * * jd_bean_home.js, tag=领京豆额外奖励, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jd_bean_home.png, enabled=true
================Loon==============
[Script]
cron "23 1,18 * * *" script-path=jd_bean_home.js, tag=领京豆额外奖励
===============Surge=================
领京豆额外奖励 = type=cron,cronexp="23 1,18 * * *",wake-system=1,timeout=3600,script-path=jd_bean_home.js
============小火箭=========
领京豆额外奖励 = type=cron,script-path=jd_bean_home.js, cronexpr="23 1,18 * * *", timeout=3600, enable=true
 */
