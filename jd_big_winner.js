...
[task_local]
#省钱大赢家之翻翻乐
20 0-23/3 * * * jd_big_winner.js, tag=省钱大赢家之翻翻乐, img-url=https://github.com/58xinian/icon/raw/master/jdgc.png, enabled=true

================Loon==============
[Script]
cron "20 0-23/3 * * *" script-path=jd_big_winner.js,tag=省钱大赢家之翻翻乐

===============Surge=================
省钱大赢家之翻翻乐 = type=cron,cronexp="20 0-23/3 * * *",wake-system=1,timeout=3600,script-path=jd_big_winner.js

============小火箭=========
省钱大赢家之翻翻乐 = type=cron,script-path=jd_big_winner.js, cronexpr="20 0-23/3 * * *", timeout=3600, enable=true
 */
