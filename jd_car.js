...
[task_local]
#京东汽车
10 7,8 * * * jd_car.js, tag=京东汽车, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jd_redPacket.png, enabled=true
================Loon==============
[Script]
cron "10 7,8 * * *" script-path=jd_car.js, tag=京东汽车
===============Surge=================
京东汽车 = type=cron,cronexp="10 7,8 * * *",wake-system=1,timeout=20,script-path=jd_car.js
============小火箭=========
京东汽车 = type=cron,script-path=jd_car.js, cronexpr="10 7,8 * * *", timeout=200, enable=true
 */
const $ = new Env('京东汽车');
