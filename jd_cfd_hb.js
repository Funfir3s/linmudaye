...
[task_local]
#财富岛兑换红包
50 * * * * jd_cfd.hb.js, tag=财富岛兑换红包, enabled=true
===========Loon============
[Script]
cron "50 * * * *" script-path=jd_cfd.hb.js,tag=财富岛兑换红包
============Surge=============
财富岛兑换红包 = type=cron,cronexp="50 * * * *",wake-system=1,timeout=3600,script-path=jd_cfd.hb.js
===========小火箭========
财富岛兑换红包 = type=cron,script-path=jd_cfd.hb.jss, cronexpr="50 * * * *", timeout=3600, enable=true
 */
