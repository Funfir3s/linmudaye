...
[task_local]
#京喜财富岛合成珍珠
30 0-23/2 * * * jd_cfd_pearl.js, tag=京喜财富岛合成珍珠, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "30 0-23/2 * * *" script-path=jd_cfd_pearl.js,tag=京喜财富岛合成珍珠

===============Surge=================
京喜财富岛合成珍珠 = type=cron,cronexp="30 0-23/2 * * *",wake-system=1,timeout=3600,script-path=jd_cfd_pearl.js

============小火箭=========
京喜财富岛合成珍珠 = type=cron,script-path=jd_cfd_pearl.js, cronexpr="30 0-23/2 * * *", timeout=3600, enable=true
