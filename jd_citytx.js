...
[task_local]
#城城领现金提现
0-50/3 0-3 * * *" jd_citytx.js, tag=城城领现金提现, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

=================================Loon===================================
[Script]
cron "0-50/3 0-3 * * *"" script-path=jd_citytx.js,tag=城城领现金提现

===================================Surge================================
城城领现金提现 = type=cron,cronexp="0-50/3 0-3 * * *"",wake-system=1,timeout=3600,script-path=jd_citytx.js

====================================小火箭=============================
城城领现金提现 = type=cron,script-path=jd_citytx.js, cronexpr="0-50/3 0-3 * * *"", timeout=3600, enable=true
 */
