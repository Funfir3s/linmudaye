...
活动时间：
更新时间  https://raw.githubusercontent.com/linmudaye/sync/jd_scripts/jd_ddworld.js
脚本兼容: QuantumultX, Surge,Loon, JSBox, Node.js
=================================Quantumultx=========================
[task_local]
#东东世界
17 10 * * * https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_ddword.js, tag=东东世界, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
=================================Loon===================================
[Script]
cron "17 10 * * *" script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_ddword.js,tag=东东世界
===================================Surge================================
东东世界 = type=cron,cronexp="17 10 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_ddword.js
====================================小火箭=============================
东东世界 = type=cron,script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_ddword.js, cronexpr="17 10 * * *", timeout=3600, enable=true
 */
const $ = new Env('东东世界');
...
!(async () => {
    ...
    let res = await getAuthorShareCode('https://raw.githubusercontent.com/linmudaye/updateTeam/master/shareCodes/ddworld.json')
    if (!res) {
        $.http.get({url: 'https://purge.jsdelivr.net/gh/linmudaye/updateTeam@master/shareCodes/ddworld.json'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
        await $.wait(1000)
        res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/linmudaye/updateTeam@master/shareCodes/ddworld.json')
    }
    let res2 = await getAuthorShareCode('https://raw.githubusercontent.com/linmudaye/updateTeam/main/shareCodes/ddworld.json')
    if (!res2) {
        await $.wait(1000)
        res2 = await getAuthorShareCode('https://raw.fastgit.org/linmudaye/updateTeam/main/shareCodes/ddworld.json')
    }
