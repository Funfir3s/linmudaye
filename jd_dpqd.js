...
[task_local]
#店铺签到
15 2,14 * * * https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_dpqd.js, tag=店铺签到, enabled=true
===========Loon============
[Script]
cron "15 2,14 * * *" script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_dpqd.js,tag=店铺签到
============Surge=============
店铺签到 = type=cron,cronexp="15 2,14 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_dpqd.js
===========小火箭========
店铺签到 = type=cron,script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_dpqd.jss, cronexpr="15 2,14 * * *", timeout=3600, enable=true
*/
const $ = new Env('店铺签到');
