...
[task_local]
#见缝插针
15 10 * * * https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_jfcz.js, tag=见缝插针, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
=================================Loon===================================
[Script]
cron "15 10 * * *" script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_jfcz.js,tag=见缝插针
===================================Surge================================
见缝插针 = type=cron,cronexp="15 10 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_jfcz.js
====================================小火箭=============================
见缝插针 = type=cron,script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_jfcz.js, cronexpr="15 10 * * *", timeout=3600, enable=true
 */
const $ = new Env('见缝插针');
