...
[task_local]
#宠汪汪积分兑换奖品
59 7,15,23 * * * https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_joy_reward.js, tag=宠汪汪积分兑换奖品, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdcww.png, enabled=true
==============Loon==============
[Script]
cron "59 7,15,23 * * *" script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_joy_reward.js,tag=宠汪汪积分兑换奖品
================Surge===============
宠汪汪积分兑换奖品 = type=cron,cronexp="59 7,15,23 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_joy_reward.js
===============小火箭==========
宠汪汪积分兑换奖品 = type=cron,script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_joy_reward.js, cronexpr="59 7,15,23 * * *", timeout=3600, enable=true
 */
  ...
  try {
    ...
    for (let j = 0; j < 20; j++) {
      ...
      if ($.getExchangeRewardsRes && $.getExchangeRewardsRes.success) {
        ...
        let rewardNum = 0;
        if ($.isNode() && process.env.JD_JOY_REWARDNAME) {
          rewardNum = process.env.JD_JOY_REWARDNAME * 1;
