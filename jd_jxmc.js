...
[task_local]
#京喜牧场
20 * * * * https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_jxmc.js, tag=京喜牧场, img-url=https://github.com/58xinian/icon/raw/master/jdgc.png, enabled=true

================Loon==============
[Script]
cron "20 * * * *" script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_jxmc.js,tag=京喜牧场

===============Surge=================
京喜牧场 = type=cron,cronexp="20 * * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_jxmc.js

============小火箭=========
京喜牧场 = type=cron,script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_jxmc.js, cronexpr="20 * * * *", timeout=3600, enable=true
 */
...
!(async () => {
  ...
  $.res = await getAuthorShareCode('https://raw.githubusercontent.com/linmudaye/updateTeam/master/shareCodes/jxmc.json')
  if (!$.res) {
    $.http.get({url: 'https://purge.jsdelivr.net/gh/linmudaye/updateTeam@master/shareCodes/jxmc.json'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
    await $.wait(1000)
    $.res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/linmudaye/updateTeam@master/shareCodes/jxmc.json')
  }
