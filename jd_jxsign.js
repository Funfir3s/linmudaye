...
[task_local]
#京喜签到
20 1,8 * * * jd_jxsign.js, tag=京喜签到, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "20 1,8 * * *" script-path=jd_jxsign.js,tag=京喜签到

===============Surge=================
京喜签到 = type=cron,cronexp="20 1,8 * * *",wake-system=1,timeout=3600,script-path=jd_jxsign.js

============小火箭=========
京喜签到 = type=cron,script-path=jd_jxsign.js, cronexpr="20 1,8 * * *", timeout=3600, enable=true
 */
