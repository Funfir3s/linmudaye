...
[task_local]
#逛京东会场
0 0,18 * * * jd_mall_active.js, tag=逛京东会场, enabled=true

================Loon==============
[Script]
cron "0 0,18 * * *" script-path=jd_mall_active.js,tag=逛京东会场

===============Surge=================
逛京东会场 = type=cron,cronexp="0 0,18 * * *",wake-system=1,timeout=3600,script-path=jd_mall_active.js

============小火箭=========
逛京东会场 = type=cron,script-path=jd_mall_active.js, cronexpr="0 0,18 * * *", timeout=3600, enable=true
