...
[task_local]
#5G超级盲盒
0 0,1-23/3 * * * https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_mohe.js, tag=5G超级盲盒, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

=================================Loon===================================
[Script]
cron "0 0,1-23/3 * * *" script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_mohe.js,tag=5G超级盲盒

===================================Surge================================
5G超级盲盒 = type=cron,cronexp="0 0,1-23/3 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_mohe.js

====================================小火箭=============================
5G超级盲盒 = type=cron,script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_mohe.js, cronexpr="0 0,1-23/3 * * *", timeout=3600, enable=true
 */
...
!(async () => {
  ...
  console.log('5G超级盲盒，可抽奖获得京豆，建议在凌晨0点时运行脚本，白天抽奖基本没有京豆，3小时运行一次收集热力值\n' +
      ...
      '更新时间：2021-8-8 19:00');
//   $.http.get({url: 'https://purge.jsdelivr.net/gh/linmudaye/updateTeam@master/shareCodes/jd_shareCodes.json'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
//   await $.wait(1000)
  await updateShareCodesCDN('https://cdn.jsdelivr.net/gh/linmudaye/updateTeam@master/shareCodes/jd_shareCodes.json')
  await $.wait(1000)
  await getShareCode()
...
function getShareCode() {
  return new Promise(resolve => {
    $.get({
      url: "https://raw.fastgit.org/linmudaye/updateTeam/master/shareCodes/jd_mohe.json",
      headers: {
        "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 13_2_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.3 Mobile/15E148 Safari/604.1 Edg/87.0.4280.88"
      },
      "timeout": 10000
