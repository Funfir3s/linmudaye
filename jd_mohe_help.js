...
[task_local]
#5G超级盲盒内部互助
5 0,19 * * * jd_mohe_help.js, tag=5G超级盲盒内部互助, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

=================================Loon===================================
[Script]
cron "5 0,19 * * *" script-path=jd_mohe_help.js,tag=5G超级盲盒内部互助

===================================Surge================================
5G超级盲盒内部互助 = type=cron,cronexp="5 0,19 * * *",wake-system=1,timeout=3600,script-path=jd_mohe_help.js

====================================小火箭=============================
5G超级盲盒内部互助 = type=cron,script-path=jd_mohe_help.js, cronexpr="5 0,19 * * *", timeout=3600, enable=true
 */
