...
————————————————
入口：[组队分豆-美泰 (https://lzkjdz-isv.isvjcloud.com/pool/captain/725732?activityId=9a1508ec3d2549dfa8187dcbfd590a34&signUuid=844f0a19886b4ed181aafa32a26e942e)]
IOS等用户直接用NobyDa的jd cookie
============Quantumultx===============
[task_local]
#组队分豆-美泰
18 2,14 * * * https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_mt.js, tag=组队分豆-美泰, enabled=true
================Loon==============
[Script]
cron "18 2,14 * * *" script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_mt.js,tag=组队分豆-美泰
===============Surge=================
组队分豆-美泰 = type=cron,cronexp="18 2,14 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_mt.js
============小火箭=========
组队分豆-美泰 = type=cron,script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_mt.js, cronexpr="18 2,14 * * *", timeout=3600, enable=true
*/
...
!(async () => {
    ...
    console.log(`若之前做过该活动，则无法重复入队。\n入口:\nhttps://lzkjdz-isv.isvjcloud.com/pool/captain/725732?activityId=9a1508ec3d2549dfa8187dcbfd590a34&signUuid=844f0a19886b4ed181aafa32a26e942e`)
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            authorCodeList = ['844f0a19886b4ed181aafa32a26e942e']
            $.bean = 0;
