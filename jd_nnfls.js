/**
 ...
 -----------------
先内部助力，有剩余助力作者
cron 1 0,19,23 * * * https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_nnfls.js
 */
const $ = new Env('牛牛福利');
...
!(async () => {
    ...
    const author = Math.random() > 0.5 ? 'linmudaye' : 'linmudaye'
...
function getShareCode(name, author = 'linmudaye', num = -1, shuffle = false) {
