...
All变量适用
————————————————
入口：[ 3.3~3.18 约惠女王节 嗨购不停 (https://lzdz1-isv.isvjcloud.com/dingzhi/customized/common/activity?activityId=uniongame20220303molpd624p&shareUuid=8c06e79d9b654d8495a8e128b9afbd8c)]
请求太频繁会被黑ip
过10分钟再执行
...
!(async () => {
  ...
  $.shareUuid = "8c06e79d9b654d8495a8e128b9afbd8c"
  console.log(`入口:\nhttps://lzdz1-isv.isvjcloud.com/dingzhi/customized/common/activity?activityId=${$.activityId}&shareUuid=${$.shareUuid}`)
  let shareUuidArr = [$.shareUuid,"8c06e79d9b654d8495a8e128b9afbd8c"]
