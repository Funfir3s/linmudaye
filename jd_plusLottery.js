...
[task_local]
#逛PLUS抽京豆
18 1 * * * jd_plusLottery.js, tag=逛PLUS抽京豆, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
================Loon==============
[Script]
cron "18 1 * * *" script-path=jd_plusLottery.js,tag=逛PLUS抽京豆
===============Surge=================
逛PLUS抽京豆 = type=cron,cronexp="18 1 * * *",wake-system=1,timeout=3600,script-path=jd_plusLottery.js
============小火箭=========
逛PLUS抽京豆 = type=cron,script-path=jd_plusLottery.js, cronexpr="18 1 * * *", timeout=3600, enable=true
*/
