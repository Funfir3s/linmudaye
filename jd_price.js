...
[task_local]
#京东保价
41 23 * * * https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_price.js, tag=京东保价, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "41 23 * * *" script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_price.js,tag=京东保价

===============Surge=================
京东保价 = type=cron,cronexp="41 23 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_price.js

============小火箭=========
京东保价 = type=cron,script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_price.js, cronexpr="41 23 * * *", timeout=3600, enable=true
 */
const $ = new Env('京东保价');
