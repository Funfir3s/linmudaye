...
[task_local]
#京东保价
55 12 * * * jd_price.js, tag=京东保价, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "55 12 * * *" script-path=jd_price.js,tag=京东保价

===============Surge=================
京东保价 = type=cron,cronexp="55 12 * * *",wake-system=1,timeout=3600,script-path=jd_price.js

============小火箭=========
京东保价 = type=cron,script-path=jd_price.js, cronexpr="55 12 * * *", timeout=3600, enable=true
 */
const $ = new Env('京东保价');
