...
[task_local]
#金榜年终奖
10 0,2 * * * https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_split.js, tag=年终奖, enabled=true

================Loon==============
[Script]
cron "10 0,2 * * *" script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_split.js,tag=年终奖

===============Surge=================
金榜年终奖 = type=cron,cronexp="10 0,2 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_split.js

============小火箭=========
金榜年终奖 = type=cron,script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_split.js, cronexpr="10 0,2 * * *", timeout=3600, enable=true
 */
const $ = new Env('金榜年终奖');
...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://raw.githubusercontent.com/linmudaye/updateTeam/master/shareCodes/split.json')
  if (!res) {
    $.http.get({url: 'https://purge.jsdelivr.net/gh/linmudaye/updateTeam@master/shareCodes/split.json'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/linmudaye/updateTeam@master/shareCodes/split.json')
  }
