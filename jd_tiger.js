...
!(async () => {
    ...
    let authorCode = []
    let res = await getAuthorShareCode('https://gitee.com/linmudaye/updateTeam/raw/master/tiger.json')
    if (!res) {
        res = await getAuthorShareCode('https://gitee.com/linmudaye/updateTeam/raw/master/tiger.json')
    }
    if (res) {
