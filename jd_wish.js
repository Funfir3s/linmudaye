...
[task_local]
#众筹许愿池
40 0,2 * * * https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_wish.js, tag=众筹许愿池, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
================Loon==============
[Script]
cron "40 0,2 * * *" script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_wish.js,tag=众筹许愿池
===============Surge=================
众筹许愿池 = type=cron,cronexp="40 0,2 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_wish.js
============小火箭=========
众筹许愿池 = type=cron,script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_wish.js, cronexpr="40 0,2 * * *", timeout=3600, enable=true
 */
const $ = new Env('众筹许愿池');
...
let appIdArr = ['1EFZWxKqP',"1EFRQwA","1EFRWxKuG","1FFVQyqw","1E1xZy6s","1EFRXxg"];
let appNameArr = ['RedmiK50新品来袭',"疯狂砸金蛋","许愿抽好礼","1111点心动","PLUS生活特权","1"];
let appId, appName;
$.shareCode = [];
if ($.isNode()) {
...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://raw.githubusercontent.com/linmudaye/updateTeam/master/shareCodes/wish.json')
  if (!res) {
    $.http.get({url: 'https://purge.jsdelivr.net/gh/linmudaye/updateTeam@master/shareCodes/wish.json'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/linmudaye/updateTeam@master/shareCodes/wish.json')
  }
