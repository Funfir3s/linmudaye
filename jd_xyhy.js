...
!(async () => {
	...
	console.log(`\n入口：https://lzdz1-isv.isvjcloud.com/dingzhi/tiger/gold/activity/15725835?activityId=dz2201100014002401&shareUuid=2b8dd3afbbc94bb39fcefba845327792\n`);
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            authorCodeList = [
                '2b8dd3afbbc94bb39fcefba845327792',
            ]
            $.bean = 0;
