...
[task_local]
#邀请有礼
08 11 * * * https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_yqyl.js, tag=邀请有礼, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
=================================Loon===================================
[Script]
cron "08 11 * * *" script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_yqyl.js,tag=邀请有礼
===================================Surge================================
邀请有礼 = type=cron,cronexp="08 11 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_yqyl.js
====================================小火箭=============================
邀请有礼 = type=cron,script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_yqyl.js, cronexpr="08 11 * * *", timeout=3600, enable=true
 */
const $ = new Env('邀请有礼');
...
!(async () => {
    ...
    if(helpAuthorFlag){
        try{
            helpAuthorInfo = await getAuthorShareCode('https://ghproxy.com/https://raw.githubusercontent.com/linmudaye/updateTeam/master/shareCodes/yqyl.json');
        }catch (e) {}
        if(!helpAuthorInfo){
            helpAuthorInfo = [];
        }
