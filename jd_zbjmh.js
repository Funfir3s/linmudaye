...
[task_local]
#直播间盲盒抽京豆
35 1 * * * jd_zbjmh.js, tag=直播间盲盒抽京豆, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "35 1 * * *" script-path=jd_zbjmh.js,tag=直播间盲盒抽京豆

===============Surge=================
直播间盲盒抽京豆 = type=cron,cronexp="35 1 * * *",wake-system=1,timeout=3600,script-path=jd_zbjmh.js

============小火箭=========
直播间盲盒抽京豆 = type=cron,script-path=jd_zbjmh.js, cronexpr="35 1 * * *", timeout=3600, enable=true
 */
